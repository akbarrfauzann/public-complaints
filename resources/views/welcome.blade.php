    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <span>DUMAS CARINGIN</span>
            </a>

            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto" style="color: goldenrod" href="{{ route('login') }}">Login</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up" style="color:green">Layananan <br>Pengaduan Masyarakat</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400" style="color:goldenrod">Sampaikan laporan Anda langsung
                        kepada instansi pemerintah berwenang melalui Aplikasi ini</h2>
                    <div data-aos="fade-up" data-aos-delay="600" style="color:green">
